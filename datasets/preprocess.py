...
def get_args():
    ...
    parser.add_argument("--output-h5-path", type=str, default="/path/to/your/output")
    parser.add_argument("--raw-dataset-path", type=str, default="/path/to/your/input")
    parser.add_argument("--split-name", type=str, default="val", choices=["train", "val"])
    ...
    for datafile_id, datafile in enumerate(datafiles):
        ...
        for i, scene_id in enumerate(scene_ids):
            ...
            for agent_id in agent_ids:
                ...
                if len(agent_data['frame_id'].tolist()) < 40:  
                    continue
